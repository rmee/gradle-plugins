...
Entsprechen werden alle Teile im gleichen Git Repository gehosted, gebaut und zusammen mittels mehrere 
...
Der konfigurierte `gcloud.key` Schlüssen bietet technischen Zugriff auf den Cluster. Für `gcloud`
